...
<template>
  <div class="flex">
    ...
    <div>
      ...
      <div class="banner-2 md:flex items-center md:justify-evenly" id="about"></div>
      ...
      <div class="banner-1 flex h-full items-center">
        <div class="w-7/12 p-12">
          <h2 class="text-gray-700 md:text-6xl text-2xl font-Eczar mb-5 font-bold">
            Let’s work together and make tech usefull
          </h2>
          <a class="underline text-2xl text-blue-600 font-work_sans">📧 yoanroszak@gmail.com</a>
        </div>
